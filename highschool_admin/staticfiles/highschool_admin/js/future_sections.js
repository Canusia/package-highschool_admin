(function($) {
    ...
    var sectionRequestsUrl = config.data('section-requests-url');
    ...
    function initPersonnelDataTable() {
        ...
        // if (!adminPositionsUrl || roleIds.length === 0 || highschoolIds.length === 0 || $table.length === 0) {
        //     return;
        // }
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.course-action', function() {
            ...
            // offering_type, not course_type: the form itself has a
