...
class PendingRecommendationGatingTests(SimpleTestCase):
    @patch('highschool_admin.highschool_admin.page_messages.student_tabs')
    @patch('highschool_admin.highschool_admin.page_messages.get_user_highschools')
    ...
    @patch('highschool_admin.highschool_admin.page_messages.student_tabs')
    @patch('highschool_admin.highschool_admin.page_messages._pending_recommendation_count', return_value=3)
    @patch('highschool_admin.highschool_admin.page_messages.get_user_highschools')
